...
var startGame = function(data) {
	...
	players.forEach(function(player, pidx) {
		...
		playerString += '<div id="ps'+player.uid+'" class="player-slot '+floatClass+'" data-uid="'+player.uid+'"><span class="avatar image"><div class="vote" style="display:none;"></div></span><div class="details"><h2>'+player.name+' ['+(pidx+1)+']</h2><span class="typing" style="display:none;">💬</span><div class="chat"></div></div></div>';
		++floatIndex;
	});
	playerString += '</div>';
